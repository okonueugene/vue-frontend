        ...
        <div class="container mt-4 mb-4">
          ...
          >
            <div class="container text-center">
              <div class="header">Approved Book Loans</div>
              <div class="row">
                <div class="card">
                  <div class="card-body">
                    <div class="row">
...
export default {
  ...
  computed: {
    totalPages() {
      return Math.ceil(this.approvedBookLoans.length / this.pageSize);
    },
    pagedBookLoans() {
      const start = (this.currentPage - 1) * this.pageSize;
      const end = this.currentPage * this.pageSize;
      return this.approvedBookLoans.slice(start, end);
    }
  },
  methods: {
    async getBookLoans() {
      try {
        ...
        const response = await axios.get(
          `${this.api}/bookloans/approved/loans`,
          {
            headers: {
